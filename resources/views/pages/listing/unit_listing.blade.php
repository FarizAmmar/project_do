                                            ...
                                            <td class="align-items-center">
                                                <div class="d-flex align-items-center">
                                                    <button class="btn btn-sm btn-light btn-approve" id="btnEdit"
                                                        ...
                                                        data-bs-target="#editmodal-{{ $unit->id }}-{{ $unit->unit_GUID }}">
                                                        <i class="fas fa-pen-to-square"></i>
                                                    </button>
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-danger btn-reject"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#confirmModal-{{ $unit->id }}-{{ $unit->unit_GUID }}">
...
@foreach ($units as $unit)
<div class="modal fade" id="confirmModal-{{ $unit->id }}-{{ $unit->unit_GUID }}" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('listing.unit.delete', ['id' => $unit->id, 'unit_guid' => $unit->unit_GUID]) }}"
                    method="POST">
                    @csrf
                    @method('delete')
...
{{-- Modal Edit --}}
@foreach ($units as $unit)
<div class="modal fade" id="editmodal-{{ $unit->id }}-{{ $unit->unit_GUID }}" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('listing.unit.update', ['id' => $unit->id, 'unit_guid' => $unit->unit_GUID]) }}"
                    method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        {{-- <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm bg-light @error('unit_code')
                                        is-invalid
                                    @enderror" id="unit_code" name="unit_code"
                                    value="{{ old('unit_code') ? old('unit_code') : $unit->unit_code }}" readonly>
                                @error('unit_code')
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="unit_type" class="form-label">Tipe Unit<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-sm @error('unit_type')
                                    is-invalid
                                @enderror" id="unit_type" name="unit_type"
                                    value="{{ old('unit_type') ? old('unit_type') : $unit->unit_type }}">
                                @error('unit_type')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="unit_VIN" class="form-label">No. Rangka<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-sm @error('unit_VIN')
                                    is-invalid
                                @enderror" id="unit_VIN" name="unit_VIN"
                                    value="{{ old('unit_VIN') ? old('unit_VIN') : $unit->unit_VIN }}"
                    ...
                    {{-- <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="unit_condition" class="form-label">Kondisi Unit<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="unit_LICENSE" class="form-label">No. Polisi<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-sm @error('unit_LICENSE')
                                    is-invalid
                                @enderror" id="unit_LICENSE" name="unit_LICENSE"
                                    value="{{ old('unit_LICENSE') ? old('unit_LICENSE') : $unit->unit_LICENSE }}"
                                    oninput="this.value = this.value.toUpperCase()">
                                @error('unit_LICENSE')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <label for="unit_LICENSE_type" class="form-label">Jenis No. Polisi<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="unit_color" class="form-label">Warna<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-sm @error('unit_color')
                                    is-invalid
                                @enderror" id="unit_color" name="unit_color"
                                    value="{{ old('unit_color') ? old('unit_color') : $unit->unit_color }}">
                                @error('unit_color')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        {{-- <div class="col">
                            <div class="mb-3">
                                <label for="unit_RegYear" class="form-label">Tahun Registrasi<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-sm @error('unit_RegYear')
                                    is-invalid
                                @enderror" id="unit_RegYear" name="unit_RegYear"
                                    value="{{ old('unit_RegYear') ? old('unit_RegYear') : $unit->unit_RegYear }}">
                                @error('unit_RegYear')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="button" class="btn btn-secondary" id="closeFormEdit" data-bs-dismiss="modal"
                ...
                <form action="{{ route('listing.unit.store') }}" method="POST">
                    ...
                    <div class="row">
                        {{-- <div class="col-6">
                            <div class="mb-3">
                                <label for="unit_code" class="form-label">Unit Code</label>
                                <input class="form-control form-control-sm bg-light" type="text" name="unit_code"
                                    id="unit_code" value="{{ 'UNT-' .fake()->unique()->randomNumber(4) }}" readonly>
                            </div>
                        </div> --}}
                        <div class="col-6">
                            <div class="mb-3">
