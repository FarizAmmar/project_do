                                        ...
                                        <tr>
                                            <th>
                                                <button class="btn btn-secondary" type="button"
                                                    data-bs-target="#modalnew" data-bs-toggle="modal">New</button>
                                            </th>
                                            <th style="vertical-align: middle;">Panggilan</th>
                                            <th style="vertical-align: middle;">Lengkap</th>
                                        </tr>
                                    </thead>
                                            ...
                                            <td class="align-items-center">
                                                <div class="d-flex align-items-center">
                                                    <button class="btn btn-sm btn-light btn-approve" id="btnEdit"
                                                        ...
                                                        data-bs-target="#editmodal-{{ $driver->id }}-{{ $driver->driver_GUID }}">
                                                        <i class="fas fa-pen-to-square"></i>
                                                    </button>
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-danger btn-reject"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modalConf{{ $driver->id }}-{{ $driver->driver_GUID }}">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel"><span class="text-danger">New</span> Registration
                    Driver</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" onclick="clearErrors()"
            ...
            <div class="modal-body">
                <form action="{{ route('listing.driver.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="driver_sname" class="form-label">Nama Panggilan<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-sm custom-bg-light @error('driver_sname')
                                            is-invalid
                                        @enderror" id="driver_sname" name="driver_sname"
                                    value="{{ old('driver_sname') }}">
                                @error('driver_sname')
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <label for="driver_lname" class="form-label">Nama Lengkap<span
                                        class="text-danger">*</span></label>
                    ...
                    {{-- <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="driver_KTP" class="form-label">Nomer KTP<span
                                        class="text-danger">*</span></label>
                                <input class="form-control form-control-sm custom-bg-light @error('driver_KTP')
                                    is-invalid
                                @enderror" type="text" id="driver_KTP" name="driver_KTP"
                                    value="{{ old('driver_KTP') }}">
                                @error('driver_KTP')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <label for="driver_email" class="form-label">E-Mail<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        {{-- <div class="col">
                            <div class="mb-3">
                                <label for="driver_stnk" class="form-label">No. STNK<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="driver_phone" class="form-label">No. Telp<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" class="btn btn-secondary" id="closeNewForm" data-bs-dismiss="modal"
                            onclick="clearErrors()">Close</button>
                    </div>
                </form>
            </div>
        </div>
...
{{-- Modal Edit --}}
@foreach ($drivers as $driver)
<div class="modal fade" id="editmodal-{{ $driver->id }}-{{ $driver->driver_GUID }}" tabindex="-1"
    aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel"><span class="text-primary">Edit</span> Registrasi
                    Driver</h1>
            ...
            <div class="modal-body">
                <form
                    action="{{ route('listing.driver.update', ['id' => $driver->id, 'driver_guid' => $driver->driver_GUID]) }}"
                    method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm @error('driver_sname')
                                            is-invalid
                                        @enderror" id="driver_sname" name="driver_sname"
                                    value="{{ old('driver_sname') ? old('driver_sname') : $driver->driver_sname }}">
                                @error('driver_sname')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm @error('driver_lname')
                                        is-invalid
                                    @enderror" id="driver_lname" name="driver_lname"
                                    value="{{ old('driver_lname') ? old('driver_lname') : $driver->driver_lname }}">
                                @error('driver_lname')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-sm @error('driver_KTP')
                                    is-invalid
                                @enderror" type="text" id="driver_KTP" name="driver_KTP"
                                    value="{{ old('driver_KTP') ? old('driver_KTP') : $driver->driver_KTP }}">
                                @error('driver_KTP')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control form-control-sm @error('driver_email')
                                    is-invalid
                                @enderror" id="driver_email" name="driver_email"
                                    value="{{ old('driver_email') ? old('driver_email') : $driver->driver_email }}">
                                @error('driver_email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        {{-- <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm @error('driver_stnk')
                                    is-invalid
                                @enderror" id="driver_stnk" name="driver_stnk"
                                    value="{{ old('driver_stnk') ? old('driver_stnk') : $driver->driver_stnk }}">
                                @error('driver_stnk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm @error('driver_phone')
                                    is-invalid
                                @enderror" id="driver_phone" name="driver_phone"
                                    value="{{ old('driver_phone') ? old('driver_phone') : $driver->driver_phone }}">
                                @error('driver_phone')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form
                    action="{{ route('listing.driver.delete', ['id' => $driver->id, 'driver_guid' => $driver->driver_GUID]) }}"
                    method="POST">
                    @csrf
                    @method('delete')
